...
while not end:
    ...
    if Menu == "c":
        ...
        if func == "1":
            ...
            f1 = input(
                "Voulez-vous savoir quels sont les mots les moins importants dans tous les discours : (y) or (n) ")
            f1.lower()
            if f1 == "y":
            ...
            f2 = input(
                "Voulez-vous savoir quel(s) est/sont le(s) mot(s) avec le plus grand score TF IDF ? : (y) or (n) ")
            f2 = f2.lower()
            if f2 == "y":
                Max_TF_idf = []
                Max = 0
            ...
            f5 = input(
                "Voulez-vous chercher un mot afin de trouver quel président l'a énoncé en premier ? (y) or (n) :")
            if f5 == "y":
